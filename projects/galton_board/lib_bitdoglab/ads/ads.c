...
uint16_t ads_get(AdChannel ad_channel){
    // Select INPUT
    switch (ad_channel) {
        case AD_JOYSTICK_X: adc_select_input(AD_CHANNEL_JOYSTICK_X); break;
        case AD_JOYSTICK_Y: adc_select_input(AD_CHANNEL_JOYSTICK_Y); break;
        case AD_TEMP:       adc_select_input(AD_CHANNEL_CPU_TEMP);       break;
        case AD_VSYS_1_3:   adc_select_input(AD_CHANNEL_VSYS_1_3);   break;
    }
